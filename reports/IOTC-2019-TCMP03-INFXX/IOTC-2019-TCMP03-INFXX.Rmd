...
The TCMP02 (2018) defined 3 interim tuning objectives for exploration for bigeye tuna, these objectives are to be tunned for the period 2030:2034. This period was defined, instead of the 20 years projection period (2019:2038), as the current state of bigeye tuna is well above SB(MSY) the tuning objectives defined in TCMP01 (2017) required depleting the stock to well below SB(MSY) by the end of the projection period. Given that the current state of swordfish stock is also above SB(MSY), it is proposed that the following tuning objectives are used:
